/*
 ...
 и управления человеками. Настоящая версия: 0.1

 Конкретно класс Human будет содержать в себе: количество
...
public class Human {
    ...
    Human(int age, String name,
          String firstName, Float salary,
          String bankAcc, float arrears){
